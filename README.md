...
This package exports `icons/paths.js` with 10,773 icon path strings.
...
the original MUI icons packages. A static HTML preview is available on [GitHub Pages](https://simprl.github.io/svgd_mui/).
